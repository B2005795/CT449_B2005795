            ...
            <!-- <div class="card-body p-0">
              <div class="row g-0">
                ...
                <h6>Quản lý</h6></div> -->
                    ...
                    <button type="button" class="btn btn-warning btn-block btn-lg mx-auto text-center" data-mdb-ripple-color="white"
                ...
                <!-- <div class="col-lg-4 bg-grey">
                  ...
                  <div class="mb-5">
                    ...
                    <button type="button" class="btn btn-warning btn-block btn-lg" data-mdb-ripple-color="white"
                      @click="registerproduct()">Đặt hàng</button>
