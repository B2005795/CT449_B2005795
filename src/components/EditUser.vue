 ...
 <div class="wrapper">
    <Form :validation-schema="userform">
      <div class="form-group mt-4">
        <label for="nameproduct" class="fw-bold mt-4">Họ tên người dùng:</label>
        ...
        <label for="nameproduct" class="fw-bold">Email:</label>
      ...
      <button type="submit" class="btn btn-info" @click="updateUser">Cập nhật</button>
      <br>
    </Form>
</div>       
</template>